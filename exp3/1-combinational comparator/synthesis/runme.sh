...
HD_PWD='C:/dsdl/exp3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_comparator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_bit_comparator.tcl
