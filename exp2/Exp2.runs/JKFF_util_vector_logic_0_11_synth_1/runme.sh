...
HD_PWD='C:/dsdl/exp2/Exp2.runs/JKFF_util_vector_logic_0_11_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JKFF_util_vector_logic_0_11.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JKFF_util_vector_logic_0_11.tcl
