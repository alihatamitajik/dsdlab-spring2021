...
HD_PWD='C:/dsdl/exp2/Exp2.runs/JKFF_NAND3_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JKFF_NAND3_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JKFF_NAND3_1_1.tcl
