...
HD_PWD='C:/dsdl/exp2/Exp2.runs/JKFF_MY_NAND_5_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JKFF_MY_NAND_5_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JKFF_MY_NAND_5_1.tcl
