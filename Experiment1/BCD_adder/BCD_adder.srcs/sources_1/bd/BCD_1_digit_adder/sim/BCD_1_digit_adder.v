...
module BCD_1_digit_adder
  ...
  BCD_1_digit_adder_HalfAdder_0_0 HalfAdder_0
       (.A(binary_4_bit_adder_1_C_out),
        .B(binary_4_bit_adder_0_C_out),
        .C_out(HalfAdder_0_C_out),
        .S(HalfAdder_0_S));
  BCD_1_digit_adder_binary_4_bit_adder_0_0 binary_4_bit_adder_0
       (.A0(A0_1),
        .A1(A1_1),
        .A2(A2_1),
        .A3(A3_1),
  ...
  BCD_1_digit_adder_binary_4_bit_adder_1_0 binary_4_bit_adder_1
       (.A0(binary_4_bit_adder_0_S0),
        ...
        .B1(util_vector_logic_0_Res[0]),
        .B2(util_vector_logic_0_Res[0]),
  ...
  BCD_1_digit_adder_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(util_vector_logic_1_Res),
        .Op2({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,binary_4_bit_adder_0_S3}),
        .Res(util_vector_logic_0_Res));
  BCD_1_digit_adder_util_vector_logic_1_0 util_vector_logic_1
       (.Op1({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,binary_4_bit_adder_0_S1}),
        .Op2({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,binary_4_bit_adder_0_S2}),
        .Res(util_vector_logic_1_Res));
  BCD_1_digit_adder_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  BCD_1_digit_adder_xlconstant_1_0 xlconstant_1
       (.dout(xlconstant_1_dout));
  BCD_1_digit_adder_xlconstant_2_0 xlconstant_2
