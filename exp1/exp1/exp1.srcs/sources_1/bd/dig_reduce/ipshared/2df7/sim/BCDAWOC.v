...
(* CORE_GENERATION_INFO = "BCDAWOC,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BCDAWOC,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=2,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "BCDAWOC.hwdef" *) 
module BCDAWOC
   (A0,
    A1,
    A2,
  ...
  assign C_out[0] = binadd4b_1_C_out;
  ...
  BCDAWOC_binadd4b_0_1 binadd4b_1
       (.A0(binadd4b_0_S0),
        ...
        .B1(util_vector_logic_1_Res),
        .B2(util_vector_logic_1_Res),
        .B3(xlconstant_0_dout),
        .C_in(binadd4b_0_C_out),
