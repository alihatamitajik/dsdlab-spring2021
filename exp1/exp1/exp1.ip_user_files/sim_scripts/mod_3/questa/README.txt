...
#
# Generated by export_simulation on Wed Mar 10 09:22:34 +0330 2021
#
################################################################################
...
'-reset_run' switch to the './mod_3.sh' script.
...
./mod_3.sh -noclean_files

For more information on the script, please type './mod_3.sh -help'.
