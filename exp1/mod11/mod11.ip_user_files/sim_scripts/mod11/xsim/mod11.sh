...
simulate()
{
  xsim mod11 -key {Behavioral:sim_1:Functional:mod11} -tclbatch cmd.tcl -protoinst "protoinst_files/Adder_4bit.protoinst" -protoinst "protoinst_files/FullAdder.protoinst" -protoinst "protoinst_files/mod11.protoinst" -protoinst "protoinst_files/bcdAdder.protoinst" -log simulate.log
}
