...
elaborate()
{
  xelab --relax --debug typical --mt auto -L util_vector_logic_v2_0_1 -L xil_defaultlib -L xlconstant_v1_1_6 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mod11 xil_defaultlib.mod11 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mod11 -key {Behavioral:sim_1:Functional:mod11} -tclbatch cmd.tcl -protoinst "protoinst_files/mod11.protoinst" -protoinst "protoinst_files/bcdAdder.protoinst" -protoinst "protoinst_files/FullAdder.protoinst" -protoinst "protoinst_files/Adder_4bit.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mod11.wdb xsim.dir)
