...
#
# Generated by export_simulation on Wed Mar 10 06:31:53 +0330 2021
#
################################################################################
...
'-reset_run' switch to the './Adder_4bit.sh' script.

./Adder_4bit.sh -reset_run
...
./Adder_4bit.sh -noclean_files

For more information on the script, please type './Adder_4bit.sh -help'.
