...
module FullAdder
  ...
  FullAdder_util_vector_logic_0_5 util_vector_logic_0
       (.Op1(A_1),
        .Op2(B_1),
        .Res(util_vector_logic_0_Res));
  FullAdder_util_vector_logic_1_1 util_vector_logic_1
       (.Op1(util_vector_logic_0_Res),
        .Op2(C_in_1),
        .Res(util_vector_logic_1_Res));
  FullAdder_util_vector_logic_2_1 util_vector_logic_2
       (.Op1(C_in_1),
        .Op2(util_vector_logic_0_Res),
        .Res(util_vector_logic_2_Res));
  FullAdder_util_vector_logic_3_1 util_vector_logic_3
       (.Op1(A_1),
        .Op2(B_1),
        .Res(util_vector_logic_3_Res));
  FullAdder_util_vector_logic_4_1 util_vector_logic_4
